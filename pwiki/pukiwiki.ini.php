...
$modifierlink = 'http://web.stanford.edu/~toshiyan/cgi-bin/cosmo/index.php';

// Default page name
$defaultpage  = 'main page';     // Top / Default page
